<div class="user_div">
    <h5 class="brand-name mb-4">WORLD JOURNALS<a href="javascript:void(0)" class="user_btn"><i class="icon-logout"></i></a></h5>
    <div class="card-body">
        <a href="page-profile.html"><img class="card-profile-img" src="{{asset('admin/images/sm/avatar1.jpg')}}" alt=""></a>
        <h6 class="mb-0">ARPIT PARIHAR</h6>
        ...
        <h5 class="brand-name mb-4">HMV<a href="javascript:void(0)" class="user_btn"><i class="icon-logout"></i></a></h5>
        <div class="card-body">
            <a href="page-profile.html"><img class="card-profile-img" src="{{asset('admin/images/sm/avatar1.jpg')}}" alt=""></a>
