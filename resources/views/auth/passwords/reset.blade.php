    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-header text-center" style="background-color: #f0f0f0; height:40px">Reset Password</div>
                <div class="card-body">
                    @if (session('success'))
                    ...
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control" name="email"  required autocomplete="email"><br>
                            </div>
                        </div>
