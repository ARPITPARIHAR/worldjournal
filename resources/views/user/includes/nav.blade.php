  ...
  <div class="container d-flex justify-content-between">
    ...
    <div class="logo">
      {{-- <!-- Uncomment below if you prefer to use an text logo --> --}}
       {{-- <h3>WORLD JOURNAL</h3> --}}
       <img src="{{asset('user/img/101.jpg')}}" alt="" class="img-fluid" id="logo"> 
      ...
      <ul>
        ...
        <li><a class="nav-link scrollto" href="contact">Contact Us</a></li>
         ...
         <li><a class="nav-link scrollto" href="#team">Promote Event</a></li>
          ...
          <li class="dropdown"><a href="#"><span>Call for paper</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
        ...
        <li class="dropdown"><a href="#"><span>Manage CFP</span> <i class="bi bi-chevron-down"></i></a>
          <ul>  
